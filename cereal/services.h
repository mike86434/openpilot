...
static struct service services[] = {
  ...
  { "gpsLocation", 8023, true, 1, 1 },
  { "ubloxGnss", 8024, true, 10, -1 },
  { "qcomGnss", 8025, true, 2, -1 },
  { "gnssMeasurements", 8026, true, 10, 10 },
  { "clocks", 8027, true, 1, 1 },
  { "ubloxRaw", 8028, true, 20, -1 },
  { "liveLocationKalman", 8029, true, 20, 5 },
  { "liveParameters", 8030, true, 20, 5 },
  { "cameraOdometry", 8031, true, 20, 5 },
  { "lateralPlan", 8032, true, 20, 5 },
  { "thumbnail", 8033, true, 0, 1 },
  { "carEvents", 8034, true, 1, 1 },
  { "carParams", 8035, true, 0, 1 },
  { "roadCameraState", 8036, true, 20, 20 },
  { "driverCameraState", 8037, true, 20, 20 },
  { "driverEncodeIdx", 8038, false, 20, 1 },
  { "driverStateV2", 8039, true, 20, 10 },
  { "driverMonitoringState", 8040, true, 20, 10 },
  ...
  { "liveMapData", 8051, true, 0, -1 },
  { "testJoystick", 8052, true, 0, -1 },
  { "roadEncodeData", 8053, false, 20, -1 },
  { "driverEncodeData", 8054, false, 20, -1 },
  { "wideRoadEncodeData", 8055, false, 20, -1 },
  { "qRoadEncodeData", 8056, false, 20, -1 },
};
#endif
