...
class CAR:
  ...
  FIT = "HONDA FIT 2018-19"
  FREED = "HONDA FREED 2020-22"
  HRV = "HONDA HRV 2019-20"
  ODYSSEY = "HONDA ODYSSEY 2018-21"
  ODYSSEY_CHN = "HONDA ODYSSEY CHN 2019"
  ACURA_RDX = "ACURA RDX 2018-22"
  ACURA_RDX_3G = "ACURA RDX 2020"
  PILOT = "HONDA PILOT 2017-18"
  PILOT_2019 = "HONDA PILOT 2019-22"
  PASSPORT = "HONDA PASSPORT 2021-22"
  RIDGELINE = "HONDA RIDGELINE 2017-22"
  INSIGHT = "HONDA INSIGHT 2019-22"
  HONDA_E = "HONDA E 2020-22"
...
FW_VERSIONS = {
  ...
  CAR.CLARITY: {
    ...
    (Ecu.eps, 0x18da30f1, None): [
        ...
        b'39990-TRW,A020\x00\x00', #2x modified firmware
        b'39990,TRW,A020\x00\x00', #3x modified firmware
    ],
    (Ecu.srs, 0x18da53f1, None): [
