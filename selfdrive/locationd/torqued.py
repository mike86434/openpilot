...
ALLOWED_FINGERPRINTS = [TOYOTA.COROLLA_TSS2, TOYOTA.COROLLA, TOYOTA.COROLLAH_TSS2, HYUNDAI.SONATA]
...
class TorqueEstimator:
  def __init__(self, CP):
    ...
    self.resets = 0.0
    self.use_params = CP.carFingerprint in ALLOWED_FINGERPRINTS or Params().get_bool("LiveTorque")
